...
//remove hidden svg in open body
remove_action( 'wp_enqueue_scripts', 'wp_enqueue_global_styles' );
remove_action( 'wp_body_open', 'wp_global_styles_render_svg_filters' );


// Register CheetSheet and Keymap Post Type
add_action( 'init', [new CheetSheetPostType, 'init'], 0 );
add_action( 'init', [new KeymapPostType, 'init'], 0 );
